...
class PlantViewHeader(Frame):
    def __init__(self,root,controller_class):
        ...
        self.middle_label = Label(self, text="Evidencija biljka",font = ('Arial',15),bg= "#8395a7")
        self.right_button = Button(self, text="Posude", font = ('Arial',15),  bg = "#ffffff", command= self.controller_class.switch_to_pots_page , relief= "solid" ,  borderwidth= 1)
